            ...
            if($subscriptionform){
                ...
                $details = [
                    ...
                    'message' => '<p>Thank you for subscribing to our newsletter. The newsletter will be sent by Temptag to your email address.</p>
                        <p>To ensure that the newsletter also reaches you and does not end up in the spam filter, please enter the sender address&nbsp;<a href="mailto:info@temptag.bestwebdevs.com">info@temptag.bestwebdevs.com</a>&nbsp;in your email program’s address book.</p>',
                    'email' => $request->email,
                ];
